    ...
    <main>
        ...
        <section class="Form">
            ...
            <?php if (!strlen($success)): ?>
                <form class="pure-form pure-form-stacked" action="<?= url('/install?action=confirm') ?>" method="post"
                    ...
                    <fieldset>
                        ...
                        <div class="pure-control-group">
                            ...
                            <input id="title" type="text" class="pure-input-1-2" placeholder="Enter something here..."
                    ...
                    <fieldset>
                        ...
                        <div class="pure-control-group">
                            ...
                            <textarea id="description" class="pure-input-1-2" placeholder="Description"
                    ...
                    <fieldset>
                        ...
                        <div class="pure-control-group">
                            ...
                            <input id="imagefolder" type="text" class="pure-input-1-2"
                                placeholder="Folder name without trailing slash (default: images)" name="imagefolder">
                        </div>
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <div class="pure-control-group">
                            ...
                            <ul>
                                <li><?= translate(string: 'password_min') ?></li>
                                <li><?= translate(string: 'password_uppercase') ?></li>
                                <li><?= translate(string: 'password_special') ?></li>
                                <li><?= translate(string: 'password_digit') ?></li>
                            </ul>
                        </div>
                    </fieldset>
